  ...
  if (method === 'POST') {
    ...
    try {
      ...
      if (universeId) {
        ...
        try {
          ...
          if (thumbRes.ok) {
            ...
            thumbUrl2 = thumbData && thumbData.data && thumbData.data[0]?.thumbnails && thumbData.data[0].thumbnails[0]?.imageUrl || '';
          }
        } catch (e) {}
      }
      ...
      if (listing) {
        ...
        if (thumbUrl2) listing.thumbUrl2 = thumbUrl2;
